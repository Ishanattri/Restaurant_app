...
export function LoginScreen({ navigation }: Props) {
  const { login } = useAuth();
  const [email, setEmail] = useState("owner@tastyhouse.test");
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Manage your menu and orders</Text>
        ...
        <TouchableOpacity style={styles.footer} onPress={() => navigation.navigate("Register")}>
          <Text style={styles.footerText}>
            New partner? <Text style={styles.footerLink}>Create an account</Text>
          </Text>
        </TouchableOpacity>
      </View>
